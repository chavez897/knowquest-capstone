    ...
    <div className="container mt-3">
      ...
      <div className="my-5">
        <div className="blog-post-text">
          ...
          <p>
            KnowQuest Inc. ("us", "we", “KnowQuest.net”, or "our") operates the
            www.KnowQuest.net website (hereinafter referred to as the
            "Service").
          </p>
          <p>
            This page informs you of our Terms and Conditions regarding the use
            of our Service.
          </p>
          <p>
            ...
            SITE OR THROUGH THE SERVICES, YOU ARE INDICATING THAT YOU HAVE READ,
            AND THAT YOU UNDERSTAND AND AGREE TO BE BOUND BY, THESE TERMS,
            WHETHER OR NOT YOU HAVE REGISTERED ON OR THROUGH THE SITE. IF YOU DO
            NOT AGREE TO THESE TERMS, THEN YOU HAVE NO RIGHT TO ACCESS OR USE
          ...
          <h4>Account</h4>
          <p>
            In order to access certain Services on the Site, an eligible person
            must setup an Account, which requires an email confirmation, user
            name, password, and security questions.
          </p>
          <h4>Account Type</h4>
          <p>
            Account Types range from students and professors, to publishers and
            content creators, researchers and institutions, as well as
          ...
          <p>
            ...
            information or other works of authorship.
          </p>
          <h4>KnowQuest.net Content</h4>
          <p>
            KnowQuest.net Content means Content that the Service makes available
          ...
          <p>
            ...
            Services and these <strong>Terms</strong>, at any time and without
            prior notice. If we modify these Terms, we will post the
            modification on the Site. We will also update the{" "}
            <strong>“Effective date”</strong> at the top of these Terms. By
            continuing to access or use the Site or Services after we have
            posted a modification on the Site, you are indicating that you agree
            to be bound by the modified Terms. If the modified Terms are not
            acceptable to you, your only recourse is to cease using the Site and
            Services.
          </p>
          ...
          <p>
            ...
            years of age or older. Any access to or use of the Site or Services
            by anyone under the age of 18 is expressly prohibited. By accessing
            or using the Site or Services you represent and warrant that you are
            18 years of age or older.
          </p>
          <h3>Account Registration</h3>
          <br />
          <p>
            In order to access certain features of the Site and Services and to
            post any Member Content on the Site or through the Services you must
            register to create an Account and become a Member.
          </p>
          <p>
            {" "}
          ...
          <p>
            See our{" "}
            <a href="https://www.knowquest.net/privacy">Privacy Policy</a> for
            information and notices concerning the Site’s collection and use of
          ...
          <p>
            ...
            to access and use the Site and Services, including to download, view
            and print any Member Content solely for your personal and
          ...
          <p>
            ...
            owned or controlled by KnowQuest.net or its licensors, except for
          ...
          <p>
            ...
            Content available through the Site or Services, you hereby grant us
            a worldwide, non-exclusive, transferable, sublicensable, perpetual,
            royalty-free license to reproduce, modify for formatting purposes,
            prepare derivative works based upon, publicly display, publicly
            perform, distribute, and otherwise use your Member Content in
            connection with operating and providing the Services and Content to
            you and to other Members. We do not claim any ownership rights in
            any Member Content and nothing in these Terms will be deemed to
            restrict any rights that you may have to use and exploit any Member
            Content.
          </p>
          <p>
            You acknowledge and agree that you are solely responsible for all
            Member Content that you make available through the Site or Services.
            ...
            available through the Site or Services or you have all rights,
            licenses, consents and releases that are necessary to grant to
            KnowQuest.net the rights in such Member Content, as contemplated
            under these Terms; and (ii) neither the Member Content nor your
            posting, uploading, publication, submission or transmittal of the
            Member Content or our use of the Member Content (or any portion
            thereof) on, through or by means of the Site or Services will
          ...
          <p>
            ...
            (iii) is fraudulent, knowingly false, misleading or deceptive; (iv)
          ...
          <p>
            2. Use, display, mirror or frame the Site, or any individual element
            within the Site or Services, KnowQuest.net’s name, any KnowQuest.net
            trademark, logo or other proprietary information, or the layout and
            design of any page or form contained on a page, without
            KnowQuest.net’s express written consent;
          </p>
          <p>
            3. Access, tamper with, or use non-public areas of the Site,
            KnowQuest.net’s computer systems, or the technical delivery systems
            of KnowQuest.net’s providers;
          </p>
          <p>
            4. Attempt to probe, scan, or test the vulnerability of any
            KnowQuest.net system or network or breach any security or
            authentication measures;
          </p>
          <p>
            5. Avoid, bypass, remove, deactivate, impair, descramble or
            otherwise circumvent any technological measure implemented by
            KnowQuest.net or any of KnowQuest.net’s providers or any other third
          ...
          <p>
            ...
            KnowQuest.net or other generally available third party web browsers;
          </p>
          <p>
          ...
          <p>
            ...
            KnowQuest.net trademark, logo URL or product name without KnowQuest
          ...
          <p>
            ...
            Site, Services or Collective Content to send altered, deceptive or
            false source-identifying information;
          </p>
          <p>
            11. Attempt to decipher, decompile, disassemble or reverse engineer
            any of the software used to provide the Site, Services or Collective
            Content;
          </p>
          <p>
            ...
            virus, overloading, flooding, spamming, or mail-bombing the Site or
            Services;
          </p>
          <p>
          ...
          <p>
            You acknowledge that we have no obligation to monitor your access to
            or use of the Site, Services or Collective Content or to review or
            edit any Collective Content, but has the right to do so for the
          ...
          <p>
            ...
            not limited to, Collective Content that we, at our sole discretion,
            consider to be in violation of these Terms or otherwise harmful to
            the Site or Services.
          </p>
          <h3>Copyright Policy</h3>
          <br />
          <p>
            We respect copyright law and expects its users to do the same. It is
            our policy to terminate, in appropriate circumstances, Members or
            other account holders who repeatedly infringe or are believed to be
            repeatedly infringing the rights of copyright holders. Please see
            our Copyright Policy at{" "}
          ...
          <p>
            ...
            resources do not imply any endorsement by knowquest.net of such
          ...
          <p>
            ...
            terminate the Site and Services and to terminate these Terms, at any
            time and without prior notice. If you breach any of these Terms, we
            will have the right to suspend or disable your Account or terminate
            these Terms, at its sole discretion and without prior notice to you.
            We reserve the right to revoke your access to and use of the Site,
            Services and Collective Content at any time, with or without cause.
            You may cancel your Account at any time by visiting your Profile
            Settings page and clicking on “Delete Account”.
          </p>
          <h3>Disclaimers</h3>
          <br />
          <p>
            ...
            OF COURSE OF DEALING OR USAGE OF TRADE. KNOWQUEST.NET MAKES NO
            ...
            QUALITY OF ANY PRODUCTS, SERVICES OR COLLECTIVE CONTENT PURCHASED OR
            OBTAINED THROUGH THE SITE OR SERVICES OR THE ACCURACY, TIMELINESS,
            TRUTHFULNESS, COMPLETENESS OR RELIABILITY OF ANY CONTENT OBTAINED
            THROUGH THE SITE OR SERVICES. NO ADVICE OR INFORMATION, WHETHER ORAL
            OR WRITTEN, OBTAINED FROM KNOWQUEST.NET OR THROUGH THE SITE,
            SERVICES OR COLLECTIVE CONTENT, WILL CREATE ANY WARRANTY NOT
            EXPRESSLY MADE HEREIN. YOU ARE SOLELY RESPONSIBLE FOR ALL OF YOUR
            COMMUNICATIONS AND INTERACTIONS WITH OTHER USERS OF THE SITE AND
            SERVICES AND WITH OTHER PERSONS WITH WHOM YOU COMMUNICATE OR
            INTERACT AS A RESULT OF YOUR USE OF THE SITE OR SERVICES. YOU
            UNDERSTAND THAT KNOWQUEST.NET DOES NOT SCREEN OR INQUIRE INTO THE
            BACKGROUND OF ANY USERS OF THE SITE OR SERVICES, NOR DOES
            KNOWQUEST.NET MAKE ANY ATTEMPT TO VERIFY THE STATEMENTS OF USERS OF
            THE SITE OR SERVICES. KNOWQUEST.NET MAKES NO REPRESENTATIONS OR
          ...
          <p>
            ...
            Site, Services or Collective Content, or your violation of these
            Terms.
          </p>
          ...
          <p>
            ...
            USE THE SITE, SERVICES OR COLLECTIVE CONTENT, OR FROM ANY
            COMMUNICATIONS, INTERACTIONS OR MEETINGS WITH OTHER USERS OF THE
            SITE OR SERVICES OR OTHER PERSONS WITH WHOM YOU COMMUNICATE OR
            INTERACT AS A RESULT OF YOUR USE OF THE SITE OR SERVICES, WHETHER
            BASED ON WARRANTY, CONTRACT, TORT (INCLUDING NEGLIGENCE), PRODUCT
            LIABILITY OR ANY OTHER LEGAL THEORY, AND WHETHER OR NOT
            KNOWQUEST.NET HAS BEEN INFORMED OF THE POSSIBILITY OF SUCH DAMAGE,
            EVEN IF A LIMITED REMEDY SET FORTH HEREIN IS FOUND TO HAVE FAILED OF
            ITS ESSENTIAL PURPOSE. IN NO EVENT WILL KNOWQUEST.NET’S AGGREGATE
            LIABILITY ARISING OUT OF OR IN CONNECTION WITH THESE TERMS OR FROM
            THE USE OF OR INABILITY TO USE THE SITE, SERVICES OR COLLECTIVE
            CONTENT EXCEED FIFTY DOLLARS ($50). THE LIMITATIONS OF DAMAGES SET
            FORTH ABOVE ARE FUNDAMENTAL ELEMENTS OF THE BASIS OF THE BARGAIN
            BETWEEN KNOWQUEST.NET AND YOU. SOME JURISDICTIONS DO NOT ALLOW THE
          ...
          <p>
            ...
            proprietary designations of knowquest.net used herein are trademarks
            or registered trademarks of knowquest.net. Any other trademarks,
          ...
          <p>
            ...
            agreement between knowquest.net and you regarding the Site, Services
            and Collective Content, and these Terms supersede and replace any
            and all prior oral or written understandings or agreements between
            knowquest.net and you regarding the Site, Services and Collective
            Content.
          </p>
          <h3>Assignment</h3>
          <br />
          <p>
            ...
            and of no effect. We may assign or transfer these Terms, at its sole
          ...
          <p>
            ...
            writing and given by knowquest.net (i) via email (in each case to
            the address that you provide); or (ii) by posting to the Site. For
          ...
          <p>
            ...
            use of the Site or Services (collectively, “Disputes”) will be
            ...
            Protection Action will be the state and federal courts located in
            the province of Ontario and each of the parties hereto waives any
            objection to jurisdiction and venue in such courts. You acknowledge
            and agree that you and KnowQuest.net are each waiving the right to a
            ...
            unless both you and KnowQuest.net otherwise agree in writing, the
          ...
          <p>
            ...
            <a href="https://knowquest.net/contact">
              www.knowquest.net/contact
            </a>
          </p>
        </div>
      </div>
